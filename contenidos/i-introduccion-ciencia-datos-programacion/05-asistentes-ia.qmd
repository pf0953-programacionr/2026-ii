...
<figure style="text-align: center; margin: 20px 0;">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="https://github.com/features/copilot">GitHub Copilot</a> en <a href="../software/rstudio.qmd">RStudio</a> y en otros editores</td>
...
4. Este ejercicio practica el ciclo completo de uso responsable: generar, comprender, verificar y criticar.
    ...
    - Ejecute el programa generado en la consola de [RStudio](../software/rstudio.qmd) —instalado en la lección de [Markdown](03-markdown.qmd)— o en Posit Cloud, con valores reales de un cantón, y verifique que el resultado sea correcto.
