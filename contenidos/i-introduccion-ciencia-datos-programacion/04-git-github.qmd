...
En esta lección, Git se practica desde el navegador, a través de GitHub, que ejecuta las operaciones por nosotros. La línea de comandos y la integración de Git en [RStudio](../software/rstudio.qmd) —que permite clonar repositorios y realizar las operaciones esenciales desde la pestaña *Git*— se retomarán más adelante, cuando se trabaje con repositorios en la computadora local.
