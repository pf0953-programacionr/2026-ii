...
Un buen mensaje de *commit* es breve y describe el cambio de forma específica ("Corrige la fórmula de densidad de población", no "cambios"). Como referencia, los mensajes del [repositorio de este curso](https://github.com/pf0953-programacionr/2026-ii) siguen una convención de ese tipo: en español y en tercera persona ("Agrega…", "Corrige…", "Actualiza…").
