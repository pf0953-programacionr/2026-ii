...
- Demo de instalación de R/RStudio en Windows para el estudiantado (que usa Windows; la máquina del profesor es Linux): pendiente. Opciones evaluadas, en orden de preferencia: (1) Windows 11 en Docker con [dockur/windows](https://github.com/dockur/windows) (KVM disponible; se ve en el navegador en el puerto 8006 o por RDP; Windows sin activar basta para la demo); (2) VM clásica con virt-manager o GNOME Boxes + ISO oficial; (3) como complemento, guiar en vivo a un estudiante que comparta pantalla siguiendo la guía de RStudio del sitio.
