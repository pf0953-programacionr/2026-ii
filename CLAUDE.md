...
- Sitio web del curso en Quarto: publicado en https://pf0953-programacionr.github.io/2026-ii/ (PR #3 mergeado; GitHub Pages habilitado desde `docs/` en `main`; semana 1 completa; proyecto de Posit Cloud creado). Falta: logo del curso, semanas siguientes (lección por lección, adaptando GF-0657 2026-II) y armar los contenidos del entorno en Mediación Virtual (encabezado VD-12784-2023, PDF del programa, enlaces al sitio, entregas, libro de calificaciones). Software de estudiantes: instalación directa de R/RStudio, Posit Cloud como respaldo.
